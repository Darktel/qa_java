...
public class TestCheckTextInAccordionPanelPassed {
    ...
    public void testCheckTextInAccordionPanelPassed(By locatorHeading, By locatorParagraph, String text)  {
        ...
        WebElement paragraph = new WebDriverWait(driver, Duration.ofSeconds(4))
                .until(ExpectedConditions.visibilityOfElementLocated(locatorParagraph));
        assertTrue(paragraph.isDisplayed(), "Элемент параграф не отображается");
